...
class Frac {
	var numerator : Int;
	 ...
	 def init(n : Int, d : Int) : Frac = {
		util = new Util();
		 ...
		 sign =(n < 0 AND(87:23)AND(87:23) d < 0 ||(0 < n || n == 0) AND(87:53)AND(87:53)(0 < d || d == 0));
	...
	def simplify() : Frac = {
		var gcd_ : Int;
		 if(!(numerator == 0) AND(111:30)AND(111:30) !(denominator == 0)) {
	...
	def times(other : Frac) : Frac = {
		return(new Frac()).init(numerator * other.getNumerator(), denominator * other.getDenominator()).simplify().setPos(this.isPos() AND(149:137)AND(149:137) other.isPos() || ! this.isPos() AND(149:171)AND(149:171) ! other.isPos());
	 }

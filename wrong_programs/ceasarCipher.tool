...
class ShowProgram {
	def run() : Boolean = {
		var t : Text;
		 ...
		 var key : Int;
		 key = 0 - 42424242;
		 t = new Text().init(25).add(new Alphabet().f()).add(new Alphabet().r()).add(new Alphabet().e()).add(new Alphabet().d()).add(new Alphabet().SPACE()).add(new Alphabet().a()).add(new Alphabet().n()).add(new Alphabet().d()).add(new Alphabet().SPACE()).add(new Alphabet().f()).add(new Alphabet().l()).add(new Alphabet().o()).add(new Alphabet().r()).add(new Alphabet().i()).add(new Alphabet().a()).add(new Alphabet().n());
		 println("The text to encrypt is: ");
		 t = t.printText();
		 println("");
		 println("Pssst, the key is: " + key);
		 println("");
		 println(STR(Let&#x27;s encode using CeasarCipher(key, text)!)(52:17));
